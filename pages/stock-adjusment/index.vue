...
{
  accessorKey: 'Total Amount Recovered',
...
<div class="py-4 flex items-center justify-between">
    ...
    <UButton to="/stock-adjusment/create">Add Stock Adjustment</UButton>
</div>
