...
{
  accessorKey: 'Advanced Balance',
  header: 'Advanced Balance',
}, 
{
  accessorKey: 'Total Sale Due',
  header: 'Total Sale Due',
}, 
{
  accessorKey: 'Total Sale Return  Due',
  header: 'Total Sale Return  Due',
}, 
{
  id: 'actions',
  enableHiding: false,
...
<div class="py-4 flex items-center justify-between">
    ...
    <UButton to="/customers/create">Add new Customer</UButton>
</div>
